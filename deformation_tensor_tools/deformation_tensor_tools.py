# Helps calculating the decomposition of the infinitesimal
# deformation tensor defined by (del u_i)/(del x_j) with 
# the fluid velocity components u_i and the coordinate 
# components x_j.
##########################################################
